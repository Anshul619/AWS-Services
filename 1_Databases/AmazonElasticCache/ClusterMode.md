...
| Feature                       | [Redis (cluster mode disabled)](https://github.com/Anshul619/HLD-System-Designs/blob/main/3_Databases/8_Caching-InMemory-Databases/Redis/RedisLeaderFollowReplication.md) | [Redis (cluster mode enabled)](https://github.com/Anshul619/HLD-System-Designs/blob/main/3_Databases/8_Caching-InMemory-Databases/Redis/RedisCluster.md) |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
