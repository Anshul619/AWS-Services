...
| [Cross-Region Replication with low replica lag (in less than 1 second)](../../../AWS-Global-Architecture-Region-AZ.md) | [Aurora uses physical, log-based asynchronous replication](https://github.com/Anshul619/Database-Internals/blob/main/AppendOnlyProperty.md)                                                                                                              |
