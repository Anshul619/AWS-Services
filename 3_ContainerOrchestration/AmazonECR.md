...
- Amazon ECR store, manage & deploy [Docker container images](../../HLD-System-Designs/9_Container&Orchestration/Docker/Readme.md).
- ECR is integrated with [ECS](../2_Compute) & [EKS](AmazonEKS.md), simplifying our development to production workflow.
- ECR hosts our images in [highly available](../../HLD-System-Designs/7a_HighAvailability/Readme.md) and [scalable architecture](../../HLD-System-Designs/7_Scalability).
