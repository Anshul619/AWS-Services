...
| List                                                                | Description                                                                                                                                                                                                                                                                                                                             |
|---------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [All comparisons list b/w Services](AWS-All-Comparisons.md)         | Comparisons between different services in AWS.                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                         |
| [All Services List](AWS-All-Services-List.md)                       | List of all services in AWS.                                                                                                                                                                                                                                                                                                            |
...
| [Serverless Architecture](13_Serverless/Readme.md)      | AWS provides easily managed [serverless architecture](13_Serverless/Readme.md).                                                                                                                                                                                                                                             |
...
<table>
  <tbody>
     <tr>
      <td>
        <a href="16_NetworkingAndContentDelivery">DNS Service, Service Discovery</a>
      </td>
      <td>
    ...
    <tr>
        <td>
            <a href="7_IdentityManagement">User Management & Security Services</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="7_IdentityManagement/AWSIAM/Readme.md" target="_blank">
                  <img src="https://i0.wp.com/sra.io/wp-content/uploads/2020/01/AWS-IAM-Exploitation.png?fit=1102%2C620&ssl=1" width="150">
                </a>
                <a href="17_Security/2_InfraProtection/AWSShield.md" target="_blank">
                ...
                <a href="17_Security/2_InfraProtection/AWSWAF.md" target="_blank">
                ...
                <a href="7_IdentityManagement/AWSDirectory/AmazonCognito.md" target="_blank">
                  <img src="https://quintagroup.com/blog/amazon-cognito/@@download/image/Amazon%20Cognito.jpg" width="150">
                </a>
                <a href="17_Security/1_DataProtection/AWSSystemManager.md" target="_blank">
                  <img src="https://digitalcloud.training/wp-content/uploads/2022/01/AWS-Systems-Manager.jpg" width="150">
                </a>
                <a href="17_Security/1_DataProtection/AWSSecretsManager.md" target="_blank">
    ...
    <tr>
      <td>
        <a href="16_NetworkingAndContentDelivery">VPC - Public, Private Subnet</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div class="block two first">
                <a href="16_NetworkingAndContentDelivery/3_NetworkFoundationsVPC/Readme.md" target="_blank">
    ...
    <tr>
      <td>
        <a href="16_NetworkingAndContentDelivery">CDN - Static Content (Image, Videos etc.)</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div>
    ...
    <tr>
      <td>
        <a href="16_NetworkingAndContentDelivery">API Gateway, Load Balancer</a>
      </td>
      <td>
        <div class="container" style="background:white">
            <div>
                <a href="16_NetworkingAndContentDelivery/2_ApplicationNetworking/AmazonAPIGateway/Readme.md" target="_blank">
                  <img src="https://www.prolim.com/wp-content/uploads/2019/09/amazon-api-gatewat-1.jpg" width="150">
                </a>
                <a href="16_NetworkingAndContentDelivery/2_ApplicationNetworking/ElasticLoadBalancer/Readme.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="3_ContainerOrchestration">Container Orchestration Services</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="3_ContainerOrchestration/AmazonECS/Readme.md" target="_blank">
                  <img src="https://i0.wp.com/miro.medium.com/max/626/1*RmiGt6GAWf4pkO9ohOnRaQ.png?w=810&ssl=1" width="150">
                </a>
                <a href="3_ContainerOrchestration/AmazonEKS.md" target="_blank">
                ...
                <a href="3_ContainerOrchestration/AmazonECR.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="1_Databases">In-Memory DB/Cache</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="1_Databases/AmazonElasticCache/Readme.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="4_MessageBrokers">Message Broker Services</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="4_MessageBrokers/AmazonSQS/Readme.md" target="_blank">
                  <img src="https://i0.wp.com/blog.knoldus.com/wp-content/uploads/2021/09/sqs.png?w=711&ssl=1" width="150">
                </a>
                <a href="4_MessageBrokers/AmazonEventBridge.md" target="_blank">
                  <img src="https://user-images.githubusercontent.com/3268013/149550617-d92fa8ff-f95d-499c-8515-0ed0be976fbf.png" width="150">
                </a>
                <a href="4_MessageBrokers/AmazonSNS.md" target="_blank">
                ...
                <a href="4_MessageBrokers/AmazonMQ.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="1_Databases/AmazonOpenSearch">Search Engine</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="1_Databases/AmazonOpenSearch" target="_blank">
    ...
    <tr>
        <td>
            <a href="1_Databases">Database Services</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="1_Databases/AmazonRDS/AmazonAurora/Readme.md" target="_blank">
                  <img src="https://allcode.com/wp-content/uploads/2022/12/Amazon-Aurora.jpg" width="150">
                </a>
                <a href="1_Databases/AmazonRDS/Readme.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="6_FileStorages">Storage Services</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="6_FileStorages/3_ObjectStorageS3/Readme.md" target="_blank">
                ...
                <a href="6_FileStorages/1_BlockStorageTypes/AmazonEBS/Readme.md" target="_blank">
                ...
                <a href="6_FileStorages/2_FileStorageTypes/AmazonEFS.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="10_BigData/DataStorage">Data Warehousing</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="10_BigData/DataStorage/DataWarehouses/AmazonRedshift.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="10_BigData/DataProcessing">Big Data Processing</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="10_BigData/DataProcessing/AmazonEMR.md" target="_blank">
    ...
    <tr>
        <td>
            <a href="8_ObservabilityLogs">Monitoring Services</a>
        </td>
        <td>
            <div class="container" style="background:white">
                <a href="8_ObservabilityLogs/AmazonCloudWatch/Readme.md" target="_blank">
                  <img src="https://miro.medium.com/max/800/1*ffbynFsxn43lPdne2kaHMQ.png" width="150">
                </a>
                <a href="8_ObservabilityLogs/AWSXRay.md" target="_blank">
