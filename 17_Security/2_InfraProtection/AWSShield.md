...
- [AWS Shield](https://aws.amazon.com/shield) provides always-on detection and automatic inline mitigations that [minimize application downtime and latency](https://github.com/Anshul619/HLD-System-Designs/blob/main/7_Scalability/Latency.md), so there is no need to engage AWS Support to benefit from DDoS protection. 
