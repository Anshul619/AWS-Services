# Security Group
- [Security groups](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) as a firewall at instance level ([EC2 instances](../../../2_Compute/AmazonEC2) etc.), controlling inbound and outbound traffic at the instance level.

# Supported AWS Services

| AWS Service                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------|
| [Amazon EC2 Instance](../../../2_Compute/AmazonEC2/Readme.md)                                                  |
| [Amazon RDS Instance](../../../1_Databases/AmazonRDS/Readme.md)                                                 |
| [Elastic Load Balancer](../../../16_NetworkingAndContentDelivery/2_ApplicationNetworking/ElasticLoadBalancer/Readme.md) |
| [Elastic File System](../../../6_FileStorages/2_FileStorageTypes/AmazonEFS.md)                                      |
| [NAT Instance](../../../)                                                                                              |
...
[Read more about IP Address Ranges](https://github.com/Anshul619/HLD-System-Designs/blob/main/14_Networking/IPAddressRanges.md)
