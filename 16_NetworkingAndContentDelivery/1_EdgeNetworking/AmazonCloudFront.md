...
- It [securely deliver content with low latency and high transfer speeds](../../../HLD-System-Designs/7_Scalability/Latency.md).
- CloudFront works as a [global Content Delivery Service (CDN)](../../../HLD-System-Designs/7_Scalability/CDNs/CDNs.md) to deliver the [static content](../../../HLD-System-Designs/7_Scalability/CDNs/StaticContent.md) efficiently to the end users.
...
| [Streaming audio or video](../../../HLD-System-Designs/7_Scalability/CDNs/StaticContent.md)                                                                            | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- [Instead of directly accessing the S3 resource](https://aws.amazon.com/blogs/networking-and-content-delivery/amazon-s3-amazon-cloudfront-a-match-made-in-the-cloud/), we should use [CloudFront distribution](AmazonCloudFront.md) in the middle (which acts as a [CDN](../../../HLD-System-Designs/7_Scalability/CDNs/CDNs.md))
...
- With [CloudFront Functions in Amazon CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/cloudfront-functions.html), lightweight functions can be developed in [JavaScript]() for [high-scale, latency-sensitive CDN customizations](../../../HLD-System-Designs/7_Scalability/CDNs/CDNs.md). 
...
- The CloudFront Functions runtime environment offers [submillisecond startup times, scales immediately to handle millions of requests per second](../../../HLD-System-Designs/7_Scalability/Throughput.md), and is highly secure. 
...
- Processing requests at AWS locations closer to the viewer instead of on [origin servers significantly reduces latency and improves the user experience](../../../HLD-System-Designs/7_Scalability/Latency.md).
