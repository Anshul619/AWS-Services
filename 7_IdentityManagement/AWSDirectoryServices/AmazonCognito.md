...
![img.png](../../19_Others/assests/amazon_cognito.png)

# Features

| Pool type                                                                              | Business Use Case               | Description                                                                                                                                                                                                                                                                                                                   |
|----------------------------------------------------------------------------------------|---------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Identity Pool](https://repost.aws/knowledge-center/cognito-user-pools-identity-pools) | Grant access to AWS Services    | Give your users access to AWS resources, such as an [Amazon Simple Storage Service (Amazon S3) bucket](../../6_FileStorages/3_S3ObjectStorage/Readme.md) or an [Amazon DynamoDB table](../../1_Databases/AmazonDynamoDB/Readme.md).<br/>- Generate temporary AWS credentials for unauthenticated users. |
