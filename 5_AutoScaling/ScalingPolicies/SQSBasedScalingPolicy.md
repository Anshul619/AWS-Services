...
- Based on the [Amazon SQS queue size](../../4_MessageBrokers/AmazonSQS/Readme.md), the [auto-scaling of the EC2 instances](../Readme.md) can also be done.
...
| Use Case                                                                                                                                                | Remarks                                                                                                                                                                                                                                                                                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Send-SMS-API design - Workers (EC instances) autoscaling using SQS queue](../../../HLD-System-Designs/0_HLDUseCasesProblems/TransactionSMSDesign/Readme.md)                |                                                                                                                                                                                                                                                                                                          |
